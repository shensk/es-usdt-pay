...
return [
    ...
    [
        ...
        'children' => [
            [
                'title' => '数据统计',
                'key' => 'plugin\\admin\\app\\controller\\OrderController@statistics',
                'href' => '/app/admin/order/statistics',
            ...
            [
                'title' => '订单管理',
                'key' => 'plugin\\admin\\app\\controller\\OrderController',
            ...
            [
                'title' => '钱包管理',
                'key' => 'plugin\\admin\\app\\controller\\WalletController',
                'href' => '/app/admin/wallet/index',
            ...
            [
                'title' => '系统配置',
                'key' => 'plugin\\admin\\app\\controller\\SystemConfigController',
                'href' => '/app/admin/system-config/index',
                'icon' => 'layui-icon-set',
                'type' => 1,
                'weight' => 700,
            ],
